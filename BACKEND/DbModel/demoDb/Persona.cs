...
public partial class Persona
{
    ...
    [InverseProperty("IdPersonaNavigation")]
    public virtual ICollection<PersonaDireccion> PersonaDirecciones { get; set; } = new List<PersonaDireccion>();

    [InverseProperty("IdPersonaNavigation")]
    public virtual ICollection<PersonaEmpleo> PersonaEmpleos { get; set; } = new List<PersonaEmpleo>();
}
